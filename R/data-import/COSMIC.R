data_import$COSMIC_vcf_to_csv <- function(given   = 'data/COSMIC/CosmicCodingMuts.vcf.gz',
...
data_import$COSMIC_nonsense <- function(given   = 'data/COSMIC/CosmicCodingMuts.csv',
